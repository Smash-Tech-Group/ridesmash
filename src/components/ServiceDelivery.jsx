    ...
    <div className="flex md:px-14 p-4 h-full py-12 md:py-0 md:h-full mx-auto md:py-[5rem] md:items-center md:justify-center bg-black">
        <div className="flex md:flex-row flex-col justify-between md:items-center max-w-screen-2xl gap-8">
            ...
            className=' md:w-2/5'>
                ...
                <p className='text-gray-400 text-md mb-4'>Get anything delivered quickly and efficiently using the Ridesmash app. From parcels and groceries to restaurant meals, Ridesmash takes care of it.</p>
                <p className='text-gray-400 text-md mb-4'>Our delivery service is available for all busy individuals who need a reliable delivery service or those who lack personal transportation.</p>
