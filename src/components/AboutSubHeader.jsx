...
const AboutSubHeader = () => {
  return (
    <div className=' items-center max-w-screen-2xl mx-auto justify-between py-14 px-4 grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 '>
        <div className='flex flex-col md:pr-6'>
            <div>
                
                <h2 className="text-stone-900 font-semibold text-xl inter text mb-1">RIDESMASH COMPANY MISSION </h2>
            </div>
            
            <h1 className="text-stone-900 font-bold text-3xl inter my-6">Experience Comfort as you Ride in Style</h1>
