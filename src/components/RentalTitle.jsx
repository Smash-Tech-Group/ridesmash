  ...
  return (
      <div className='flex mt-[1.5rem] md:mt-0 md:pt-5'>
       ...
       <div className="w-full md:w-96 md:items-center md:justify-center items-center justify-center h-full md:h-1/3 mx-5 lg:mx-10">
           <h1 className="text-2xl md:text-gray-300 text-gray-300 md:text-4xl font-black inter">Car Rental</h1>
           <div className="flex flex-row py-2 items-center">
               ...
               <p className="ml-1 text-base text-gray-300 md:text-white lg:text-1xl">Car Rental</p>
           </div>
