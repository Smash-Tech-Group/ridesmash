    ...
    <div className="flex h-full md:px-14 p-4 py-[4rem] mx-auto py-10 md:my-0 md:items-center md:justify-center bg-black">
        <div className="flex max-w-screen-2xl mx-auto md:flex-row flex-col justify-between md:items-center gap-8">
            ...
            className=' md:w-2/5'>
                ...
                <p className='text-gray-300 text-md md:text-md mb-7'>Ridesmash is a multinational entity, which primarily operates by connecting drivers for on-demand transportation services. 
                Ridesmash connects passengers with drivers who use their own or leased vehicles to provide rides.

               </p>

               <p className='text-gray-300 text-md mb-7'>                 Passengers can request a ride through the Ridesmash app, specify their location and destination, and then be connected with a nearby available driver. 
                
 </p>
            
                  <p className='text-gray-300 text-md mb-7'>                  
